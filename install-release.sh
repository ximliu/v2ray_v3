...
downloadV2Ray(){
    ...
    DOWNLOAD_LINK="https://github.com/ximliu/v2ray_v3/releases/download/${NEW_VER}/v2ray-linux-${VDIS}.zip"
...
getVersion(){
    if [[ -n "$VERSION" ]]; then
        ...
        TAG_URL="https://api.github.com/repos/ximliu/v2ray_v3/releases/latest"
